...
export const Interactive3DViewer: React.FC<Interactive3DViewerProps> = ({ lang }) => {
  ...
  const [lightingColor, setLightingColor] = useState<string>('#00E5FF'); // cyan default
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div>
          <div className="flex items-center space-x-3 mb-3">
            <span className="inline-block w-2.5 h-2.5 rounded-full bg-[#00E5FF] animate-pulse" />
            <span className="text-xs font-bold tracking-[0.25em] text-[#00E5FF] uppercase">
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-xs font-bold transition-all ${
                  isSelected
                    ? 'bg-[#00E5FF] text-[#0A0F14] shadow-[0_0_15px_rgba(0,229,255,0.4)]'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        <div className="lg:col-span-8 glass-panel rounded-2xl p-4 md:p-6 relative overflow-hidden flex flex-col min-h-[420px] md:min-h-[500px]">
          ...
          <div className="flex justify-between items-center z-10 mb-2">
            <div className="flex items-center space-x-3">
              <span className="px-2.5 py-1 bg-white/10 border border-white/15 rounded text-[11px] font-mono text-[#00E5FF]">
                {activeModel.name}
              </span>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className={`p-2 rounded-lg border text-xs font-medium flex items-center space-x-1.5 transition-all ${
                  isWireframe
                    ? 'bg-[#0052FF]/30 border-[#0052FF] text-[#00E5FF]'
                    : 'bg-white/5 border-white/10 text-gray-400 hover:text-white'
                }`}
        ...
        <div className="lg:col-span-4 flex flex-col justify-between gap-4">
          <div className="glass-panel p-6 rounded-2xl space-y-6">
            <div>
              <h3 className="text-xs font-bold tracking-widest text-[#00E5FF] uppercase mb-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  ...
                  { color: '#0052FF', name: 'Kinetic Blue' },
                  { color: '#5AFF9B', name: 'Laser Neon' },
                  { color: '#FF00B4', name: 'Holo Pink' },
                ].map(item => (
                  <button
                    key={item.color}
                    onClick={() => {
            ...
            <div>
              <div className="flex justify-between text-xs text-gray-400 mb-2">
                ...
                <span className="font-mono text-[#00E5FF]">{(zoom * 100).toFixed(0)}%</span>
              </div>
              <input
                type="range"
                min="0.6"
            ...
            <div className="pt-2 border-t border-white/10 space-y-2 text-xs">
              ...
              <div className="flex items-center justify-between text-gray-400">
                ...
                <span className="text-[#00E5FF] font-mono flex items-center">
          ...
          {/* Quick Action */}
          <div className="glass-panel p-5 rounded-2xl bg-gradient-to-br from-[#0052FF]/20 to-transparent border border-[#00E5FF]/30">
            ...
            <a
              ...
              className="inline-flex items-center text-xs font-bold text-[#00E5FF] hover:text-white transition-colors"
            >
