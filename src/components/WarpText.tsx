...
const buildTextCanvas = ({
  ...
  Object.assign(probe.style, {
    ...
    lineHeight: typeof props.lineHeight === 'number' ? String(props.lineHeight) : props.lineHeight || '1'
  });
...
const syncUniforms = (program: any, props: WarpTextProps) => {
  ...
  if (uniforms.uWarpStrength) uniforms.uWarpStrength.value = props.warpStrength ?? 0.08;
  if (uniforms.uWarpScale) uniforms.uWarpScale.value = props.warpScale ?? 1.7;
  if (uniforms.uSpeed) uniforms.uSpeed.value = props.speed ?? 0.55;
  if (uniforms.uPointerInfluence) uniforms.uPointerInfluence.value = props.pointerInfluence ?? 0.42;
  if (uniforms.uPointerStrength) uniforms.uPointerStrength.value = props.pointerStrength ?? 0.38;
  if (uniforms.uRefraction) uniforms.uRefraction.value = props.refraction ?? 0.018;
  if (uniforms.uRipple) uniforms.uRipple.value = props.ripple ? 1 : 0;
};
