...
import { X, Printer, Download, Mail, MapPin, Globe, Phone, Award, CheckCircle2, FileText } from 'lucide-react';
import { Language } from '../types';
import { translations, experienceData, skillCategoriesData } from '../data/portfolioData';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 bg-black/85 backdrop-blur-xl overflow-y-auto animate-fade-in">
      <div className="relative w-full max-w-4xl glass-panel-heavy rounded-2xl border border-white/20 shadow-2xl overflow-hidden my-auto max-h-[94vh] flex flex-col">
        {/* Modal Controls Bar */}
        <div className="p-4 md:p-6 border-b border-white/10 flex items-center justify-between bg-[#0A0F14]/90 z-20 print:hidden">
        ...
        <div className="overflow-y-auto p-6 md:p-10 space-y-8 bg-[#0C0E10] text-gray-200">
          {/* Header Card */}
          <div className="border-b border-white/15 pb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <p className="text-sm font-bold text-[#00E5FF] font-mono tracking-wide">
          ...
          <div>
            <h3 className="text-xs font-bold text-[#00E5FF] uppercase font-mono tracking-widest mb-4 flex items-center space-x-2">
            ...
            <div className="space-y-6">
              {experienceData.map((exp) => (
                <div key={exp.id} className="border-l-2 border-[#00E5FF]/40 pl-4 space-y-1.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-white/15">
            <div>
              <h4 className="text-xs font-bold text-[#00E5FF] uppercase font-mono tracking-wider mb-2">
                EDUCATION & DEGREES
              </h4>
            ...
            <div>
              ...
              <div className="text-xs text-gray-300 space-y-1">
                ...
                <p className="text-[11px] text-[#00E5FF] font-mono mt-1">Available for Remote Global Contracts</p>
              </div>
            </div>
          </div>
        </div>
