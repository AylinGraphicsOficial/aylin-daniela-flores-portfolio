...
import { Box, Sparkles, PenTool, Video, CheckCircle, Award, Compass, Cpu } from 'lucide-react';
...
export const AboutSection: React.FC<AboutSectionProps> = ({ lang }) => {
  ...
  return (
    <section id="about" className="py-20 md:py-32 px-4 md:px-8 max-w-7xl mx-auto border-t border-white/10 relative">
      {/* Background glow */}
      <div className="absolute top-1/2 left-0 w-80 h-80 bg-[#00E5FF]/10 rounded-full blur-[120px] pointer-events-none" />

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-16">
        {/* Left: Professional Portrait Frame */}
        <div className="lg:col-span-5 relative group">
          {/* Ambient Glow */}
          <div className="absolute inset-0 bg-gradient-to-tr from-[#0052FF] to-[#00E5FF] blur-[80px] opacity-20 group-hover:opacity-40 transition-opacity duration-700 pointer-events-none" />

          <div className="glass-panel p-2.5 rounded-2xl relative z-10 overflow-hidden shadow-2xl">
            <div className="relative overflow-hidden rounded-xl bg-[#0C0E10]">
              <img
              ...
              <div className="absolute bottom-4 left-4 right-4 glass-panel-heavy p-3 rounded-xl flex items-center justify-between border border-white/20">
                <div>
                  <span className="text-[10px] font-mono text-[#00E5FF] font-bold block uppercase tracking-widest">
                    {t.about.basedIn}
                  </span>
                ...
                <div className="w-8 h-8 rounded-lg bg-[#00E5FF]/20 border border-[#00E5FF]/50 flex items-center justify-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-bold tracking-[0.25em] text-[#00E5FF] uppercase font-mono">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tight leading-none">
            {t.about.titleSub}{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] via-[#BDF4FF] to-[#0052FF]">
              {t.about.titleHighlight}
            </span>{' '}
            {t.about.titleEnd}
          </h2>

          <p className="text-base md:text-lg text-gray-300 leading-relaxed border-l-2 border-[#00E5FF] pl-6 py-1">
            {t.about.bio}
          </p>
          ...
          <div className="pt-2">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={tool}
                  className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:border-[#00E5FF]/50 text-xs font-mono text-gray-200 hover:text-white transition-colors"
                >
                  {tool}
                </span>
              ))}
      ...
      <div className="mt-12 glass-panel p-6 md:p-8 rounded-2xl">
        <div className="flex flex-col md:flex-row justify-between md:items-center mb-8 gap-4 pb-6 border-b border-white/10">
          <div>
            <h3 className="text-xs font-bold text-[#00E5FF] uppercase tracking-widest font-mono mb-1">
            ...
            <div key={skill.name} className="p-4 rounded-xl bg-white/[0.02] border border-white/5 space-y-2">
              <div className="flex justify-between items-center text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  {skill.isHighlight && (
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-[#0052FF]/30 text-[#00E5FF] border border-[#0052FF]">
                      PRIMARY
                    </span>
                  )}
                </div>
              ...
              <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#0052FF] to-[#00E5FF] rounded-full transition-all duration-700 ease-out shadow-[0_0_10px_#00E5FF]"
